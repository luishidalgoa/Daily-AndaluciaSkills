class List {
    ...
    getHtml() {
        return `
        <div id="contains" style="position: relative" class="p-0 w-100 h-100">
            ...
            <!--Modulo Bars-->
            <form style="height: 100vh;width:fit-content;max-width: 70vw;left: -250px;position: fixed;z-index: 1;background-color:rgb(103, 199, 195,.7);backdrop-filter: blur(10px)" class="">
                <ul class="d-flex gap-2 flex-column p-2 fs-4 fst-italic m-0" style="position: relative;font-weight: 650">
                    <li class="w-100 glass-strong h-100 p-1 text-light d-flex aling-content-center" style="border-radius: 5px;position: relative">
                        <svg style="height: 100%; width: 35px" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 64 64" stroke-width="2.5" stroke="#CACBD2" fill="white" class="duration-300 transform transition-all">
                            <path d="M45.77 51a.09.09 0 01.11 0l3.4 3.31s.12 0 .12-.07V9.7H14.6v44.46a.08.08 0 00.13.07l4.38-3.29a.08.08 0 01.1 0l4.53 3.33a.08.08 0 00.11 0l4-3.33h.11l4.52 3.32a.08.08 0 00.11 0l4.2-3.26a.09.09 0 01.12 0l4.51 3.31a.09.09 0 00.12 0l4-3.3M18.72 31.11h13.3M18.72 25.77h15.97M18.72 15h17.33M18.72 20.11h14.43M41.01 30.95h4.27M18.72 36.81h15.97M41.86 36.66h3.42M41.01 42.56h4.27M41.01 25.61h4.27M41.86 20.11h3.42M41.01 15h4.27" stroke-linecap="round"></path>
                        </svg>
                        <span>My Tasks</span></li>
                    <li class="w-100 glass-strong h-100 p-1 text-light d-flex aling-content-center" style="border-radius: 5px;position: relative">
                        <svg style="height: 100%; width: 35px;padding: 3px" viewBox="0 0 24 24" fill="white" xmlns="http://www.w3.org/2000/svg">
                            <path d="M12 4C11.4477 4 11 3.55229 11 3V1C11 0.447715 11.4477 0 12 0C12.5523 0 13 0.447715 13 1V3C13 3.55229 12.5523 4 12 4Z" fill="white"/><g clip-path="url(#clip0_36_883)"><path d="M17.6569 6.34315C17.2663 5.95262 17.2663 5.31946 17.6569 4.92894L19.0711 3.51472C19.4616 3.1242 20.0948 3.1242 20.4853 3.51472C20.8758 3.90525 20.8758 4.53841 20.4853 4.92894L19.0711 6.34315C18.6806 6.73367 18.0474 6.73367 17.6569 6.34315Z" fill="white"/><path d="M21 11C20.4477 11 20 11.4477 20 12C20 12.5523 20.4477 13 21 13H23C23.5523 13 24 12.5523 24 12C24 11.4477 23.5523 11 23 11H21Z" fill="white"/><path d="M17.6569 17.6569C18.0474 17.2663 18.6806 17.2663 19.0711 17.6569L20.4853 19.0711C20.8758 19.4616 20.8758 20.0948 20.4853 20.4853C20.0948 20.8758 19.4616 20.8758 19.0711 20.4853L17.6569 19.0711C17.2663 18.6805 17.2663 18.0474 17.6569 17.6569Z" fill="white"/><path d="M12 24C11.4477 24 11 23.5523 11 23V21C11 20.4477 11.4477 20 12 20C12.5523 20 13 20.4477 13 21V23C13 23.5523 12.5523 24 12 24Z" fill="white"/><path fill-rule="evenodd" clip-rule="evenodd" d="M12 18C15.3137 18 18 15.3137 18 12C18 8.68629 15.3137 6 12 6C8.68629 6 6 8.68629 6 12C6 15.3137 8.68629 18 12 18ZM12 16C14.2091 16 16 14.2091 16 12C16 9.79086 14.2091 8 12 8C9.79086 8 8 9.79086 8 12C8 14.2091 9.79086 16 12 16Z" fill="white"/><path d="M3.51472 3.51472C3.90524 3.1242 4.53841 3.1242 4.92893 3.51472L6.34315 4.92894C6.73367 5.31946 6.73367 5.95263 6.34315 6.34315C5.95262 6.73368 5.31946 6.73368 4.92893 6.34315L3.51472 4.92894C3.1242 4.53841 3.1242 3.90525 3.51472 3.51472Z" fill="white"/><path d="M3.51472 20.4853C3.1242 20.0948 3.1242 19.4616 3.51472 19.0711L4.92894 17.6569C5.31946 17.2663 5.95263 17.2663 6.34315 17.6569C6.73368 18.0474 6.73368 18.6805 6.34315 19.0711L4.92894 20.4853C4.53841 20.8758 3.90525 20.8758 3.51472 20.4853Z" fill="white"/><path d="M0 12C0 11.4477 0.447715 11 1 11H3C3.55229 11 4 11.4477 4 12C4 12.5523 3.55229 13 3 13H1C0.447715 13 0 12.5523 0 12Z" fill="white"/></g><defs><clipPath id="clip0_36_883"><rect width="24" height="24" fill="white"/></clipPath></defs>
                        </svg>  
                        <span>My Tasks</span>
                    </li>
                </ul>
    ...
    getMenuHtml(){
        return `
            <form style="height: 100vh;width:fit-content;max-width: 70vw;position: fixed;left: -200px;z-index: 1;background-color:rgb(103, 199, 195,.7);backdrop-filter: blur(10px)" class="">
                <ul class="d-flex gap-2 flex-column p-2 fs-4 fst-italic m-0" style="position: relative;font-weight: 650">
                    <li class="w-100 glass-strong h-100 p-1 text-light d-flex aling-content-center" style="border-radius: 5px;position: relative">
                        <svg style="height: 100%; width: 35px" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 64 64" stroke-width="2.5" stroke="#CACBD2" fill="white" class="duration-300 transform transition-all">
                            <path d="M45.77 51a.09.09 0 01.11 0l3.4 3.31s.12 0 .12-.07V9.7H14.6v44.46a.08.08 0 00.13.07l4.38-3.29a.08.08 0 01.1 0l4.53 3.33a.08.08 0 00.11 0l4-3.33h.11l4.52 3.32a.08.08 0 00.11 0l4.2-3.26a.09.09 0 01.12 0l4.51 3.31a.09.09 0 00.12 0l4-3.3M18.72 31.11h13.3M18.72 25.77h15.97M18.72 15h17.33M18.72 20.11h14.43M41.01 30.95h4.27M18.72 36.81h15.97M41.86 36.66h3.42M41.01 42.56h4.27M41.01 25.61h4.27M41.86 20.11h3.42M41.01 15h4.27" stroke-linecap="round"></path>
