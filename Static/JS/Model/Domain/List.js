class List {
    ...
    getHtml() {
        ...
        <div id="contains" style="position: relative;max-width: 100vw" class="p-0 w-100 h-100">
            ...
            <form id="menuList" action="javascript:void(0);">
                ...
                <div class="p-2" id="addList" style="max-width: 168px;position: absolute;bottom: 70px">
    ...
    getMenuHtml(list){
        ...
        return `
            <li id="`+id+`" class="w-100 glass-strong h-100 p-1 text-light d-flex aling-content-center" style="border-radius: 5px;position: relative">
                `+list.svg+`
                <span>`+list.name+`</span>
